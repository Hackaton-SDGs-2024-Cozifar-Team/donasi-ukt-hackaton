    ...
    <div class="pt-8 w-full flex flex-col gap-2 text-greyText">
        <div class="row flex px-[100px] gap-10">
            <span class="flex flex-1 flex-col gap-2 mb-5">
                ...
                <input type="file" name="registrant_ktp" id="registrant_ktp"
                    class="bg-grey border-none px-5 py-1 rounded-md" placeholder="Masukan KTP Anda">
                @error('name')
            ...
            <span class="flex flex-1 flex-col gap-2 mb-5">
                ...
                <input type="file" name="family_card" id="family_card" class="bg-grey border-none px-5 py-1 rounded-md"
            ...
            <span class="flex flex-1 flex-col gap-2 mb-5">
                ...
                <input type="file" name="birth_certificate" id="birth_certificate"
                    class="bg-grey border-none px-5 py-1 rounded-md" placeholder="Masukan akta kelahiran Anda!">
                @error('email')
                <p class="text-red">{{ $message }}</p>
                @enderror
            </span>
        ...
        <div class="row flex px-[100px] gap-10">
            <span class="flex flex-1 flex-col gap-2 mb-5">
                ...
                <input type="file" name="sktm" id="sktm" class="bg-grey border-none px-5 py-1 rounded-md"
            ...
            <span class="flex flex-1 flex-col gap-2 mb-5">
                ...
                <input type="file" name="lant_certificate" id="lant_certificate"
                    class="bg-grey border-none px-5 py-1 rounded-md" placeholder="Masukan surat tanah">
                @error('email')
                <p class="text-red">{{ $message }}</p>
                @enderror
            </span>
