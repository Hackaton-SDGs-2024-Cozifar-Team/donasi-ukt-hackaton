...
@section('content')
            ...
            <ul class="nav nav-tabs nav-fill" role="tablist">
                ...
                <li class="nav-item">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-keluarga" aria-controls="navs-keluarga" aria-selected="false">
                        <i class="tf-icons bx bx-home"></i> Keluarga
                    </button>
                </li>
                <li class="nav-item">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-ekonomi" aria-controls="navs-ekonomi" aria-selected="false">
                        <i class="tf-icons bx bx-message-square"></i> Ekonomi
                    </button>
                </li>
                <li class="nav-item">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                        data-bs-target="#navs-tambahan" aria-controls="navs-tambahan" aria-selected="false">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('img/data-pendaftar/' . $student->additional_information->registrant_ktp) }}"
                                                width="200px" alt=""> </td>
                                    </tr>
                                    <tr>
                                        <th><strong>Foto Kartu Keluarga</strong></th>
                                        <td><img src="{{ asset('img/data-pendaftar/' . $student->additional_information->family_card) }}"
                                                width="200px" alt=""> </td>
                                    </tr>
                                    <tr>
                                        <th><strong>Foto Akta Kelahiran</strong></th>
                                        <td><img src="{{ asset('img/data-pendaftar/' . $student->additional_information->birth_certificate) }}"
                                                width="200px" alt=""> </td>
                                    </tr>
                                    <tr>
                                        <th><strong>Foto Sertifikat Tanah</strong></th>
                                        <td><img src="{{ asset('img/data-pendaftar/' . $student->additional_information->lant_certicate) }}"
                                                width="200px" alt=""> </td>
                                    </tr>
                                    <tr>
                                        <th><strong>Foto Stnk motor</strong></th>
                                        <td><img src="{{ asset('img/data-pendaftar/' . $student->additional_information->vehicle_stnk) }}"
                                                width="200px" alt=""> </td>
                                    </tr>
                                    <tr>
                                        <th><strong>Foto Rumah tampak luar</strong></th>
                                        <td><img src="{{ asset('img/data-pendaftar/' . $student->additional_information->house_from_outside) }}"
                                                width="200px" alt=""> </td>
                                    </tr>
                                    <tr>
                                        <th><strong>Foto Rumah tampak dalam</strong></th>
                                        <td><img src="{{ asset('img/data-pendaftar/' . $student->additional_information->house_from_inside) }}"
                                                width="200px" alt=""> </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form
                action="{{ route('mahasiswa.update-academic', $student->academic_information->id_academic_information) }}"
                method="post">
                @csrf
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" id="nameBasic" name="fullname" value="{{ $student->users->fullname }}"
                        ...
                        <div class="row g-2">
                            <div class="col mb-0">
                                ...
                                <input type="text" id="emailBasic" class="form-control"
                                    value="{{ $student->users->place_birth }}" name="place_birth" placeholder="Masukan tempat" />
                            </div>
                            <div class="col mb-0">
                                <label for="dobBasic" class="form-label">tanggal lahir</label>
                                <input type="date" id="dobBasic" class="form-control"
                                    value="{{ $student->users->date_birth }}" name="birth_date" placeholder="DD / MM / YY" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="nameBasic" class="form-label">Alamat</label>
                                <input type="text" id="nameBasic" name="address" class="form-control"
                                    value="Sumberaden rt 01 / rw 06 Mronjo Selopuro Blitar" placeholder="Enter Name" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-3">
                                <label for="nameBasic" class="form-label">Program studi</label>
                                <input type="text" id="nameBasic" name="study_program" class="form-control"
                                    value="{{ $student->academic_information->study_program }}"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                name="faculty"
                                    value="{{ $student->academic_information->faculty }}" placeholder="Enter Name" />
                            </div>
                        </div>
                        ...
                        <div class="row g-2">
                            <div class="col mb-0">
                                ...
                                <input type="number" id="emailBasic"
                                name="study_year"
                                    value="{{ $student->academic_information->study_year }}" class="form-control"
                            ...
                            <div class="col mb-0">
                                ...
                                name="now_semester"
                                    value="{{ $student->academic_information->now_semester }}"
                        ...
                        <div class="row g-2">
                            <div class="col mb-0">
                                ...
                                <input type="number" name="last_gpa" id="emailBasic"
                                    value="{{ $student->academic_information->last_gpa }}" class="form-control"
                                    placeholder="Masukan tempat" />
                            </div>
                            <div class="col mb-0">
                                ...
                                <input type="number" id="dobBasic" class="form-control"
                                name="now_ukt"
                                    value="{{ $student->academic_information->now_ukt }}" placeholder="DD / MM / YY" />
                            </div>
                        </div>
