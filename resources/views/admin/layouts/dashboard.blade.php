                            ...
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                      ...
                                      <i class="rounded fa-solid fa-upload" style="padding: 13px;background-color: rgba(101, 139, 255, 0.4)"></i>
                                    </div>
                                    <div class="dropdown">
                    ...
                    <div class="col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                      <i class="rounded fa-solid fa-users"  style="padding: 13px;background-color: rgba(255, 152, 241, 0.4)"></i>
                    ...
                    <div class="col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                      <i class="rounded fa-solid fa-list-check" style="padding: 13px;background-color: rgba(68, 255, 0, 0.4)"></i>
                                    </div>
                                    <div class="dropdown">
                            ...
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                      ...
                                      <i class="rounded fa-solid fa-xmark" style="padding: 13px;background-color: rgba(255, 98, 0, 0.4)"></i>
